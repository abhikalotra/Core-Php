                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                 ...
                                 <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
										<?php 
											$booking_select = mysql_query("select * from booking  where  status = '0' ORDER BY  `bookingid` DESC ");
											...
											<tr>
                                                ...
                                                <td><?php echo $date; ?></td>
                                                <td><?php echo $time; ?></td>
                                                <td><a href="delete_cancel_booking_history.php?id=<?php echo $id;?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
											</tr>
											<?php 	}   ?>
										</tbody>
									</table>
