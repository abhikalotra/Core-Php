 ...
 -->
              ...
              <?php 
                ...
                <div class="imageOuter">
                  <a class="image"  href="adminpanel/gallery_images/<?php echo $gallery_image; ?>" title="<?php echo $title; ?>" target="blank">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 send-msg cntct-main">
              <div class="cntct-heading">
                ...
                <?php } ?>
              <p>when an unknown printer took a galley of scrambled specimen book.</p>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 twitter-sec media-sec">
              ...
              <div class="facebook-inside">
                ...
                <div class="social-desc">
                  <p><a TARGET="_blank" href="https://www.facebook.com/cafelluca/" style="color: #FFF;font-family: Roboto-Light;width: 100%;">Visited us on facebook</a></p>
                </div>
              </div>
            </div>
          </div>
